class User:
    ...
    def follow(self, another_user):
        self.following_list.append(another_user)  #Adding following list from classname to method
        followingCount = self.num_following()

        another_user.followers_list.append(self)  #Adding follower list from method to class
        followersCount = self.num_followers()
